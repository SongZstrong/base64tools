        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            Contact Us
              ...
              Have a question, suggestion, or need help with our tools? We&apos;d love to hear from you. Fill out the form below and we&apos;ll get back to you as soon as possible.
            </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@base64toolsonine.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Technical support for all our tools</p>
                    <p className="text-sm text-gray-500">Bug reports and feature requests welcome</p>
                  </div>
                </div>
              </div>
